...
const Plumiferos = () => {
  ...
  const { data: products = [], isLoading } = useProductsByCategory('plumiferos');
  ...
  return (
    <>
      <SEOHead
        title="Plumíferos y Chalecos en La Loggia | Moda mujer Alicante"
        description="Descubre nuestra colección de plumíferos y chalecos de las mejores marcas en La Loggia. Tiendas en Altea, San Juan y Campello."
        canonicalPath="/plumiferos"
      />
      <div className="min-h-screen bg-background">
        ...
        <main className="py-6">
          <header className="text-center mb-6">
            <h1 className="section-title">Plumíferos y Chalecos</h1>
