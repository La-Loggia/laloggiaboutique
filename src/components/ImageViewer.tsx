    ...
    <div ref={contentRef} className="fixed inset-0 z-[100] bg-neutral-100 overflow-y-auto">
      ...
      <div className="pt-20 md:pt-20 pb-28 md:pb-24">
        ...
        <div className="px-3 md:px-8 max-w-6xl mx-auto">
          ...
          {/* WhatsApp button - below image on mobile */}
          <div className="md:hidden mt-4">
            <a
              href={whatsappUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 w-full bg-foreground text-background font-sans text-[13px] tracking-wide py-3 rounded-xl transition-all duration-300 hover:bg-foreground/90 active:scale-95"
            >
      ...
      {/* WhatsApp button - fixed only on desktop */}
